            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <a href="/content/form" type="button" class="btn btn-default"><i class="fa fa-plus"></i> 新增</a>&nbsp;&nbsp;&nbsp;
                            <button type="button" class="btn btn-default" onclick="App.deleteMulti('/content/delete')"><i class="fa fa-trash-o"></i> 删除</button>&nbsp;&nbsp;&nbsp;
